...
#define StackLimit 30   // το όριο μεγέθους της στοίβας, ενδεικτικά ίσο με 50
...
int main()
{
    StackElementType AnItem, TopElement;
    StackType AStack;
    int i;
    ...
    GetTopElementA(&AStack, &TopElement);
    printf("Top with GetTopElementA = %d\n", TopElement);
    TraverseStack(AStack);

    GetTopElementB(AStack, &TopElement);
