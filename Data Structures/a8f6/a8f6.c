...
char *userProperty[] = {"student", "postgraduate student", "teacher", "visitor"};
...
int main(){
   ...
   do{
        ...
        if(Loc == -1){
            ...
            printf("[%d, %s, %s]\n", HList.List[Loc].RecKey, HList.List[Loc].Data.Name, userProperty[HList.List[Loc].Data.Property - 1]);
            /*switch(HList.List[Loc].Data.Property){
            case 1:
                printf("[%d, %s, student]\n", HList.List[Loc].RecKey, HList.List[Loc].Data.Name);
                break;
            case 2:
                printf("[%d, %s, postgraduate student]\n", HList.List[Loc].RecKey, HList.List[Loc].Data.Name);
                break;
            case 3:
                printf("[%d, %s, teacher]\n", HList.List[Loc].RecKey, HList.List[Loc].Data.Name);
                break;
     ...
     printf("USERS:\n");
          for (i=0; i<HMax;i++)
          {
              ...
              if (SubIndex != EndOfList){
                ...
                {
                   /*switch(HList.List[SubIndex].Data.Property){
                    case 1:
                        printf("%d:[%d, %s, student]\n", SubIndex, HList.List[SubIndex].RecKey, HList.List[SubIndex].Data.Name);
                        break;
                    case 2:
                        printf("%d:[%d, %s, postgraduate student]\n", SubIndex, HList.List[SubIndex].RecKey, HList.List[SubIndex].Data.Name);
                        break;
                    case 3:
                        printf("%d:[%d, %s, teacher]\n", SubIndex, HList.List[SubIndex].RecKey, HList.List[SubIndex].Data.Name);
                        break;
                    case 4:
                        printf("%d:[%d, %s, visitor]\n", SubIndex, HList.List[SubIndex].RecKey, HList.List[SubIndex].Data.Name);
                        break;
                    }*/
                    printf("%d:[%d, %s, %s]\n", SubIndex, HList.List[SubIndex].RecKey, HList.List[SubIndex].Data.Name, userProperty[HList.List[SubIndex].Data.Property - 1]);
